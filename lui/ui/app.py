...
ASCII_ART = "A U T O L O O M - 2   v2.0.0   by CASSANDRA MELAX"
    ...
    def compose(self) -> ComposeResult:
        ...
        yield Container(
            ...
            Container(
                ...
                Container(
                    Container(
                        Static("T:", classes="tiny-label"),
                        Input(value="0.7", id="temp-input", classes="tiny-input"),
                        Static("Tok:", classes="tiny-label"),
                        Input(value="100", id="tokens-input", classes="tiny-input"),
                        Static("N:", classes="tiny-label"),
                        Input(value="5", id="gen-count-input", classes="tiny-input"),
                        Static("W:", classes="tiny-label"),
                        Input(value="10", id="wait-time-input", classes="tiny-input"),
                        classes="params-single-row"
                    ),
                    id="settings"
                ),
